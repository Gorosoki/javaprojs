...
public class Driver
{
    public static void main (String [] args)
    {
        ...
        bowler.setFramesToBowl(5);              // play a 5 frame game instead of a 10 frame one
        
        bowler.bowlOneGame();
        
        bowler.setSparePercentage(1.0);         // a game that will score OK
        bowler.setOpenFramePercentage(0.0);
        
        bowler.bowlOneGame();
        
        bowler.setSparePercentage(0.0);
        bowler.setStrikePercentage(1.0);        // a perfect game!
